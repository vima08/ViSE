 ...
 * @author Vitaly
 */
public class SimpleTwoGroupExperimentM extends ExperimentManager {    
    ...
    public SimpleTwoGroupExperimentM(Experiment experiment, Environment env, Person groupMan, int groupSize, Person egoist, int egoSize) throws CloneNotSupportedException {
